...
class HeaderlessTableAssistantTests(TableAssistantTestCase):
    ...
    def setUpClass(cls):
        ...
        super(HeaderlessTableAssistantTests, cls).setUpClass()
        cls.table_assist = HeaderlessTableAssistant(cls.table)

    @classmethod
    def tearDownClass(cls):
        super(HeaderlessTableAssistantTests, cls).tearDownClass()
