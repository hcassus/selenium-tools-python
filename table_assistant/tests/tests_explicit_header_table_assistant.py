...
from table_assistant.explicit_header_table_assistant import ExplicitHeaderTableAssistant
...
class ExplicitHeaderTableAssistantTests(TableAssistantTestCase):
    ...
    def setUpClass(cls):
        ...
        super(ExplicitHeaderTableAssistantTests, cls).setUpClass()
        cls.table_assist = ExplicitHeaderTableAssistant(cls.table)

    @classmethod
    def tearDownClass(cls):
        super(ExplicitHeaderTableAssistantTests, cls).tearDownClass()
