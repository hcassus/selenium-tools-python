...
from selenium_tools.table_assistant.abstract.header_table_assistant import HeaderTableAssistant
from selenium_tools.table_assistant.interfaces.titled_table_assistant import TitledTableAssistant
